...
class Elements extends Component {
  ...
  componentDidMount() {
    // get api youtube
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDBVV6e4Afldka51vqFgaipCf08YOP4XWs&channelId=UCudmrVrWjfb5FdRm_1yrtUA&part=snippet,id&order=date&maxResults=4"
    )
      .then(resp => resp.json())
    ...
    // get api twitter
    fetch("/wp-content/plugins/michel-blocks/src/blocks/social-media-wall/components/requests/twitter.php", {
      method: "GET"
    })
      .then(resp => resp.json())
